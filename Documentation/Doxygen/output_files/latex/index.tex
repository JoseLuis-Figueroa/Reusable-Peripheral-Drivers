...
Welcome to the documentation for the Reusable Drivers! This project is a personal endeavor focused on developing reusable firmware for microcontroller platforms. The goal is to create modular and efficient firmware components that can be easily adapted to various microcontrollers.\hypertarget{index_version}{}\doxysection{Version Log}\label{index_version}
...
\begin{DoxyItemize}
\item Provide a set of reusable drivers and HALs for microcontroller peripherals such as GPIO, SPI, etc.
